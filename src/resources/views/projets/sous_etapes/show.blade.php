<x-app-layout>
    <x-slot name="header">
        <div class="w-full flex flex-col gap-4 sm:flex-row sm:items-start">
            ...
            <div class="flex flex-col gap-1">
                ...
                <p class="text-sm text-gray-700">
                    Étape :
                    {{ $etape->parent?->titre_personnalise ?: ($etape->parent?->etapeModele?->libelle ?? '—') }}
                </p>
                        ...
                        <table class="min-w-full text-sm border-separate border-spacing-0">
                            <thead>
                                <tr class="text-center text-xs font-semibold uppercase text-gray-500">
                                    <th class="p-3 text-xs sm:text-sm">Titre</th>
                            ...
                            <tbody class="align-top">
                                @foreach($etape->documents as $document)
                                    ...
                                    >
                                        <td class="p-3 text-xs sm:text-sm text-center font-medium text-gray-900">
                                            {{ $document->titre }}
                                        </td>
